...
import com.example.sohbetapp.Adapters.MessageAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    public void tanimla()
    {
        ...
        String isim=getUserName();
        String [] bol=isim.split(":");
        chat_username_textview=(TextView)findViewById(R.id.chat_username_textview);
        chat_username_textview.setText(bol[1]);
    ...
    public void action()
    {
        ...
        sendMessageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendMessage(firebaseUser.getUid(),getId(),"text",getDate(),false,message);
            }
        });
    }
